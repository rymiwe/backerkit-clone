...
RSpec.describe RewardItem, type: :model do
  ...
  describe "CRUD operations" do
    ...
    it "creates a valid reward item" do
      ...
      expect(RewardItem.count).to eq(1)
    end
    ...
    it "reads reward item attributes" do
      ...
      found_item = RewardItem.find(item.id)
    ...
    it "deletes a reward item" do
      ...
      expect { item.destroy }.to change(RewardItem, :count).by(-1)
    end
  end
end
