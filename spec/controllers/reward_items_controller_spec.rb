...
RSpec.describe RewardItemsController do
  ...
  describe "reward items CRUD operations" do
    ...
    describe "POST #create" do
      ...
      it "creates a new reward item" do
        ...
        end.to change(RewardItem, :count).by(1)
    ...
    describe "DELETE #destroy" do
      ...
      context "when reward item has fulfillment records" do
        ...
        let!(:backer_fulfillment) do
          create(:backer_item_fulfillment, reward_item: reward_item, pledge: pledge, shipped: false)
        end

        it "does not allow deletion" do
          expect do
            delete :destroy, params: { project_id: project.id, reward_id: reward.id, id: reward_item.id }
          end.not_to change(RewardItem, :count)
