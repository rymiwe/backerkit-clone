...
RSpec.describe BackerItemFulfillmentsController, type: :controller do
  ...
  let!(:reward_item) { create(:reward_item, reward: reward, name: "Test Item", quantity_per_reward: 1, produced_count: 10, shipped_count: 0, total_needed: 10) }
  ...
  describe "fulfillment CRUD operations" do
    ...
    describe "POST #create" do
      it "creates a new backer item fulfillment" do
        ...
        }.to change(BackerItemFulfillment, :count).by(1)
        ...
        expect(fulfillment.shipped).to eq(false)
      end
    end
    ...
    describe "PUT #update" do
      ...
      it "handles bulk updates for multiple backers" do
        ...
        fulfillment2.reload
        expect(fulfillment.shipped).to eq(true)
        expect(fulfillment2.shipped).to eq(true)
    ...
    describe "DELETE #destroy" do
      ...
      context "when fulfillment has been shipped" do
        let!(:shipped_fulfillment) { create(:backer_item_fulfillment, reward_item: reward_item, pledge: pledge, shipped: true) }
        ...
        it "does not allow deletion of shipped records" do
          ...
          }.not_to change(BackerItemFulfillment, :count)
